    ...
    return (
      <Card className="border-blue-200 dark:border-blue-800 bg-blue-50/30 dark:bg-blue-950/10">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl text-foreground">Session Ended!</CardTitle>
    ...
    return (
      <Card className="border-blue-200 dark:border-blue-800">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl text-foreground">Live Voice Session</CardTitle>
          <p className="text-muted-foreground">
        ...
        <CardContent className="space-y-6">
          <div className="p-4 bg-muted/50 rounded-xl">
            <ul className="text-sm text-muted-foreground space-y-2">
              <li>• Real-time voice conversation with your AI mentor</li>
              <li>• Instant feedback on learning topics</li>
              <li>• Performance evaluation at the end of the session</li>
            </ul>
          </div>
    ...
    return (
      <Card className="border-blue-200 dark:border-blue-800">
        <CardContent className="py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground">Setting up your voice session</p>
        </CardContent>
      </Card>
    );
  }
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-700 dark:to-blue-800 text-white p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold">Engineering Mentor</p>
        ...
        <div className="space-y-4 max-w-3xl mx-auto">
          ...
          {interimTranscript && (
            <div className="flex gap-3 justify-end opacity-50">
              <div className="max-w-[80%] p-4 rounded-2xl bg-primary/70 text-primary-foreground rounded-br-md">
      ...
      <div className="bg-background border-t border-border p-4">
        ...
        <div className="flex flex-col items-center gap-4 max-w-3xl mx-auto">
            ...
            {audioLevel.map((level, idx) => (
              <div
                ...
                className={cn(
                  ...
                  isSpeaking ? 'bg-blue-500' : isAISpeaking ? 'bg-primary' : 'bg-muted-foreground/30'
                )}
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              className={cn(
                ...
                isSpeaking && 'ring-4 ring-blue-200 dark:ring-blue-800'
              )}
              onClick={toggleMic}
              disabled={aiThinking}
            >
          ...
          <p className="text-sm text-muted-foreground text-center">
            {isAISpeaking ? 'Mentor is speaking... Tap to interrupt' :
