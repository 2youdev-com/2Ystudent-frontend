...
const SKILL_LABELS: Record<keyof SkillScores, { en: string; ar: string }> = {
  communication: { en: 'Technical Communication', ar: 'Technical Communication' },
  negotiation: { en: 'Knowledge Depth', ar: 'Knowledge Depth' },
  objectionHandling: { en: 'Problem Solving', ar: 'Problem Solving' },
  relationshipBuilding: { en: 'Safety Awareness', ar: 'Safety Awareness' },
  productKnowledge: { en: 'Practical Application', ar: 'Practical Application' },
  closingTechnique: { en: 'Critical Thinking', ar: 'Critical Thinking' },
};

const LEVEL_CONFIG = {
  beginner: { en: 'Beginner', ar: 'Beginner', color: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400' },
  intermediate: { en: 'Intermediate', ar: 'Intermediate', color: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' },
  advanced: { en: 'Advanced', ar: 'Advanced', color: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' },
};
          ...
          {(report.strengths.length > 0 || report.weaknesses.length > 0) && (
            <div className="mt-3 flex flex-wrap gap-2">
              {report.strengths.map((s) => {
                ...
                return (
                  <Badge key={s} variant="secondary" className="text-xs bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400">
