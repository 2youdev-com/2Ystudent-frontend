...
export function AddUserModal({
  ...
  const roles = [
    { value: 'student', labelAr: 'طالب', labelEn: 'Student', descAr: 'يمكنه التدريب فقط', descEn: 'Can only train' },
    { value: 'supervisor', labelAr: 'مشرف', labelEn: 'Supervisor', descAr: 'يمكنه مراقبة الطلاب', descEn: 'Can monitor students' },
  ];
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              {'Share the password with the user securely'}
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                {formData.role === 'supervisor'
                  ? 'The supervisor will be assigned to this group'
                  : 'The student will be added to this group'}
              </p>
            </div>
          )}
