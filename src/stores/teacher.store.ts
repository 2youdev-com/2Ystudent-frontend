...
interface TeacherState {
  ...
  // Group-based AI teacher filtering
  groupAITeacherNames: string[];
  ...
  setGroupAITeachers: (teacherNames: string[]) => void;
  reset: () => void;
}
...
export const useTeacherStore = create<TeacherState>()(
  persist(
    (set) => ({
      ...
      setGroupAITeachers: (teacherNames: string[]) => {
        set({
          groupAITeacherNames: teacherNames,
          hasGroupFilter: teacherNames.length > 0,
        });
      },
