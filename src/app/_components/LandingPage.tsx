...
/**
 * 2YStudy Landing Page — Client Component
 * Handles interactivity: scroll animations, language context, hover effects
 */
      ...
      <main className="flex-grow">
        ...
        <section id="hero" className="relative min-h-[100vh] flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bounce-arrow cursor-pointer" onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })}>
            <ChevronDown className="h-8 w-8 text-muted-foreground/70 hover:text-primary transition-colors" />
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {[
                { value: '10,000+', label: t.landing.stats.activeStudents, delay: '0' },
        ...
        <section id="features" className="py-20 sm:py-28 bg-background relative">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {[
                { icon: MessageSquare, title: t.landing.features.aiSimulations.title, description: t.landing.features.aiSimulations.description, gradient: 'from-primary to-emerald-600', iconBg: 'from-primary/10 to-primary/5' },
                { icon: Phone, title: t.landing.features.voiceCalls.title, description: t.landing.features.voiceCalls.description, gradient: 'from-purple-600 to-purple-700', iconBg: 'from-purple-100 to-purple-50 dark:from-purple-900/30 dark:to-purple-800/20', iconColor: 'text-purple-600 dark:text-purple-400' },
                { icon: BarChart, title: t.landing.features.analytics.title, description: t.landing.features.analytics.description, gradient: 'from-success to-emerald-600', iconBg: 'from-success/10 to-success/5', iconColor: 'text-success' },
                { icon: BookOpen, title: t.landing.features.courses.title, description: t.landing.features.courses.description, gradient: 'from-warning to-amber-600', iconBg: 'from-warning/10 to-warning/5', iconColor: 'text-warning' },
                { icon: Award, title: t.landing.features.certifications.title, description: t.landing.features.certifications.description, gradient: 'from-destructive to-red-600', iconBg: 'from-destructive/10 to-destructive/5', iconColor: 'text-destructive' },
                { icon: Globe, title: t.landing.features.bilingual.title, description: t.landing.features.bilingual.description, gradient: 'from-info to-sky-600', iconBg: 'from-info/10 to-info/5', iconColor: 'text-info' },
              ].map((feature, i) => (
                <div key={i} data-scroll-reveal className={cn("reveal-up", `reveal-up-${(i % 3) + 1}`)}>
                  <Card className="h-full flex flex-col group hover:shadow-xl hover:-translate-y-2 transition-all duration-500 border-border/50 hover:border-primary/30 bg-card/80 backdrop-blur-sm overflow-hidden card-hover-glow magnetic">
                    <CardContent className="p-7 relative flex-1 flex flex-col">
                      <div className={cn("absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-5 transition-opacity duration-500", feature.gradient)} />
                      <div className={cn("relative w-14 h-14 rounded-2xl flex items-center justify-center mb-5 transition-all duration-500", "bg-gradient-to-br", feature.iconBg, `group-hover:bg-gradient-to-br group-hover:${feature.gradient}`)}>
                        <feature.icon className={cn("h-7 w-7 transition-all duration-300 icon-bounce", feature.iconColor || "text-primary", "group-hover:text-white group-hover:scale-110")} />
                      </div>
        ...
        <section id="how-it-works" className="py-20 sm:py-28 bg-muted/30 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative">
            <div className="text-center mb-16" data-scroll-reveal>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">{t.landing.howItWorks.title}</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">{t.landing.howItWorks.subtitle}</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
              {[
                { step: 1, title: t.landing.howItWorks.step1.title, description: t.landing.howItWorks.step1.description, gradient: 'from-primary to-emerald-600' },
                { step: 2, title: t.landing.howItWorks.step2.title, description: t.landing.howItWorks.step2.description, gradient: 'from-purple-600 to-purple-700' },
                { step: 3, title: t.landing.howItWorks.step3.title, description: t.landing.howItWorks.step3.description, gradient: 'from-success to-emerald-600' },
              ].map((item, i) => (
                <div key={i} data-scroll-reveal className={cn("reveal-up", `reveal-up-${i + 1}`)}>
                  <div className="relative group text-center">
                    {i < 2 && (
                      <div className={cn("hidden md:block absolute top-12 h-1 bg-gradient-to-r rounded-full", item.gradient, "opacity-30", isRTL ? "left-0 -translate-x-1/2 w-full" : "right-0 translate-x-1/2 w-full")} />
                    )}
                    <div className="relative inline-flex mb-8">
                      <div className={cn("w-24 h-24 rounded-3xl flex items-center justify-center text-4xl font-bold text-white shadow-2xl", "bg-gradient-to-br", item.gradient, "group-hover:scale-110 group-hover:shadow-xl transition-all duration-500 float-continuous")}>
                        <span className="counter-animate">{item.step}</span>
                      </div>
                      <div className={cn("absolute inset-0 rounded-3xl blur-xl opacity-30 group-hover:opacity-60 transition-opacity pulse-grow", "bg-gradient-to-br", item.gradient)} />
                    </div>
                    <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">{item.title}</h3>
        ...
        <section id="testimonials" className="py-20 sm:py-28 bg-background relative">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-16" data-scroll-reveal>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">{t.landing.testimonials.title}</h2>
                ...
                <div key={index} data-scroll-reveal className={cn("reveal-up", `reveal-up-${index + 1}`)}>
                  <Card className="h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-500 border-border/50 bg-card/80 backdrop-blur-sm card-tilt magnetic">
                    <CardContent className="p-6 relative">
                      ...
                      <p className="text-muted-foreground mb-6 leading-relaxed relative">&ldquo;{testimonial.quote}&rdquo;</p>
        ...
        <section className="py-24 sm:py-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative" data-scroll-reveal>
            <div className="text-center max-w-4xl mx-auto">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">{t.landing.cta.title}</h2>
              <p className="text-lg sm:text-xl text-white/80 mb-10 max-w-2xl mx-auto leading-relaxed">{t.landing.cta.description}</p>
              <Link href="/register">
                <Button
                  size="lg"
                  className={cn(
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            ...
            <div className="col-span-2 md:col-span-1">
              <Image src="/light-logo.png" alt="2YSTUDY" width={120} height={32} className="h-8 w-auto mb-4 dark:hidden" />
              <Image src="/logo-white.png" alt="2YSTUDY" width={120} height={32} className="h-8 w-auto mb-4 hidden dark:block" />
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><Link href="/login" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.courses}</Link></li>
                <li><Link href="/login" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.simulations}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><Link href="/about" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.about}</Link></li>
                <li><Link href="/about" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.blog}</Link></li>
                <li><Link href="/about" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.careers}</Link></li>
                <li><Link href="/contact" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.contact}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><Link href="/privacy" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.privacy}</Link></li>
                <li><Link href="/terms" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.terms}</Link></li>
                <li><Link href="/cookies" className="text-muted-foreground hover:text-primary transition-colors">{t.landing.footer.cookies}</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-all duration-300 jelly-hover">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
              </a>
              <a href="https://github.com/inBots-Organization" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-all duration-300 jelly-hover">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-all duration-300 jelly-hover">
