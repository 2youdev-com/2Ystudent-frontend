...
export default function UsersPage() {
  ...
  const getRoleBadge = (role: string) => {
    const roleConfig: Record<string, { color: string; label: string; labelAr: string }> = {
      ...
      org_admin: { color: 'bg-rose-500/10 text-rose-600 dark:text-rose-400', label: 'Admin', labelAr: 'مدير' },
      admin: { color: 'bg-rose-500/10 text-rose-600 dark:text-rose-400', label: 'Admin', labelAr: 'مدير' },
      trainer: { color: 'bg-blue-500/10 text-blue-600 dark:text-blue-400', label: 'Supervisor', labelAr: 'مشرف' },
      supervisor: { color: 'bg-blue-500/10 text-blue-600 dark:text-blue-400', label: 'Supervisor', labelAr: 'مشرف' },
      trainee: { color: 'bg-gray-500/10 text-gray-600 dark:text-gray-400', label: 'Student', labelAr: 'طالب' },
      student: { color: 'bg-gray-500/10 text-gray-600 dark:text-gray-400', label: 'Student', labelAr: 'طالب' },
    };
    ...
    <div className={cn('space-y-6', isRTL && 'rtl')}>
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {organizationFilter
            ? 'Viewing users for selected organization'
