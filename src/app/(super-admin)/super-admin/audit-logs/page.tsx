...
export default function AuditLogsPage() {
  ...
  const getActionLabel = (action: string): { label: string; labelAr: string; color: string } => {
    const actionConfig: Record<string, { label: string; labelAr: string; color: string }> = {
      ...
      organization_impersonated: { label: 'Org Impersonated', labelAr: 'انتحال مؤسسة', color: 'bg-rose-500/10 text-rose-600' },
      ...
      user_role_changed: { label: 'Role Changed', labelAr: 'تغيير دور', color: 'bg-rose-500/10 text-rose-600' },
    };
          ...
          <form onSubmit={handleSearch} className="flex flex-col lg:flex-row gap-4">
            ...
            <Select value={actionFilter} onValueChange={setActionFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="organization_suspended">Org Suspended</SelectItem>
                <SelectItem value="subscription_assigned">Sub Assigned</SelectItem>
                <SelectItem value="subscription_cancelled">Sub Cancelled</SelectItem>
