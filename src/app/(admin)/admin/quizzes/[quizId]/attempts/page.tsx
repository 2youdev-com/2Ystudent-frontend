      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <Users className="w-7 h-7 text-[#0089B8]" />
            {t.quiz.attempts}
          </h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-3xl font-bold text-[#0089B8]">{attempts.length}</div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-gray-50 dark:bg-gray-800">
                    <th className="px-4 py-3 text-start font-medium text-gray-500">{'Student'}</th>
                    ...
                    <tr key={attempt.attemptId} className="border-b hover:bg-gray-50 dark:hover:bg-gray-800">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 rounded-full bg-[#0089B8]/10 flex items-center justify-center">
                            <User className="w-4 h-4 text-[#0089B8]" />
                          </div>
