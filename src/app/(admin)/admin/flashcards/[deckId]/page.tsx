            ...
            <CardContent className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                <Input
                  ...
                  value={newCard.front}
                  onChange={(e) => setNewCard(prev => ({ ...prev, front: e.target.value, frontAr: e.target.value }))}
                />
                <Input
                  placeholder={`${t.flashcard.back} *`}
                  value={newCard.back}
                  onChange={(e) => setNewCard(prev => ({ ...prev, back: e.target.value, backAr: e.target.value }))}
                />
                <Input
                  placeholder={`${t.flashcard.hint}`}
                  value={newCard.hint || ''}
                  onChange={(e) => setNewCard(prev => ({ ...prev, hint: e.target.value, hintAr: e.target.value }))}
                />
              </div>
