...
export default function EmployeesPage() {
  ...
  // Supervisors can only view, admins can modify
  const canModifyEmployees = permissions?.canModifyEmployees ?? isAdmin;
  ...
  const getScoreBadge = (score: number | null) => {
    ...
    if (score >= 80) return { label: 'A', className: 'bg-blue-500/20 text-blue-500' };
  ...
  const getRoleBadge = (role: string) => {
    if (role === 'org_admin' || role === 'admin') {
      return (
        <Badge className="bg-[#0089B8]/20 text-[#0089B8] border-[#0089B8]/30 text-xs">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
            {isSupervisor && <GraduationCap className="h-6 w-6 text-[#0089B8]" />}
            {isSupervisor
              ? ('My Students')
              : ('Team Members')
            }
          ...
          <p className="text-muted-foreground mt-1">
            {isSupervisor
              ? ('Monitor your assigned students performance')
              : ('Manage and monitor employee performance')
            }
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Select value={sortBy} onValueChange={(value) => { setSortBy(value); setCurrentPage(1); }}>
              ...
              <SelectContent>
                ...
                <SelectItem value="averageScore">{'Score'}</SelectItem>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              <div className={cn(
                ...
                <Shield className={cn("h-5 w-5", isSupervisor ? "text-[#0089B8]" : "text-[#0089B8]")} />
              </div>
              <div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {/* Actions Menu - Only for admin (not supervisors) and not current user */}
            ...
            <div className="text-center py-12">
              ...
              {searchTerm && (
                <Button
                  ...
                  className={cn("mt-2", isSupervisor ? "text-[#0089B8]" : "text-[#0089B8]")}
                >
                  {'Clear search'}
                </Button>
              )}
      ...
      <ConfirmationModal
        ...
        description={`Are you sure you want to delete "${deleteModal.employee?.firstName} ${deleteModal.employee?.lastName}"? All their data will be permanently removed.`}
        confirmText={'Delete'}
        variant="danger"
        icon="delete"
      ...
      <ConfirmationModal
        ...
        reasonPlaceholder={'Reason for suspension (optional)'}
        isLoading={actionLoading}
      />
