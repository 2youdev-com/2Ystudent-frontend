...
import { studentApi, DashboardStats } from '@/lib/api/trainee.api';
...
export default function DashboardPage() {
  ...
  // BUG-022: Determine if dashboard content should be locked
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      ...
      {/* BUG-022: Locked Assessment CTA */}
      {isAssessmentLocked && (
        <Card className="mb-8 border-2 border-amber-500/50 bg-gradient-to-br from-amber-500/10 via-background to-background shadow-lg">
          <CardContent className="flex flex-col sm:flex-row items-center gap-6 py-8 px-6">
            <div className="p-4 rounded-2xl bg-amber-500/15 shrink-0">
            ...
            <div className="flex-1 text-center sm:text-start">
              ...
              <p className="text-muted-foreground">
                Before you can access courses and simulations, we need to understand your current skill level. Complete the initial assessment to unlock all content.
              </p>
            </div>
            <Link href="/assessment" className="shrink-0">
              <Button size="lg" className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white shadow-lg gap-2">
                Start Assessment
      ...
      {/* Wrap content in blur container when assessment is locked */}
      <div className={cn(isAssessmentLocked && 'opacity-30 pointer-events-none blur-[2px] select-none')}>
      ...
      <div className="grid gap-6 lg:grid-cols-3 mb-8">
        ...
        <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="flex-1">
                      ...
                      {data.currentCourse.nextLectureTitle && (
                        <p className={cn('text-sm text-muted-foreground', isRTL && 'font-arabic')}>
                          Next: {data.currentCourse.nextLectureTitle}
                        </p>
                      )}
                    </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            {/* TEMPORARY: Voice Practice card disabled until AI review */}
            {/* <Card className="border border-border shadow-lg hover:shadow-xl transition-all group">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-foreground group-hover:text-primary transition-colors">
              ...
              <CardContent>
                <div className="p-3 bg-muted/30 rounded-lg border border-border mb-4">
                  ...
                  <Badge variant="secondary" className="mt-2 bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/20">
      ...
      <Card className="border border-border shadow-lg">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            ...
            <div className="text-center p-4 bg-gradient-to-br from-[#0089B8]/5 to-transparent rounded-xl border border-border">
              <div className="p-2 rounded-lg bg-[#0089B8]/10 w-fit mx-auto mb-2">
                    ...
                    <div className="text-end">
                      {session.score !== null && (
                        <Badge variant={session.score >= 70 ? 'default' : 'secondary'} className={cn(
                          session.score >= 70 ? 'bg-blue-500/10 text-blue-600 dark:text-blue-400' : ''
                        )}>
                          {session.score}%
                        </Badge>
                      )}
