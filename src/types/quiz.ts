...
export interface QuizOption {
  ...
  isCorrect?: boolean; // Only available in admin view, stripped for student taking
...
/** @deprecated Use StudentAttemptHistoryItem instead */
export type TraineeAttemptHistoryItem = StudentAttemptHistoryItem;
