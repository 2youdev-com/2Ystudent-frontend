...
// Dynamic categories — loaded from backend DB
...
export const adminCoursesApi = {
  ...
  createCategory: async (data: { labelEn: string; labelAr?: string }): Promise<{ category: CategoryOption }> => {
    return apiClient.post<{ category: CategoryOption }>('/admin/courses/categories', data);
  },

  /** Delete a course category */
  deleteCategory: async (categoryId: string): Promise<{ message: string }> => {
    return apiClient.delete<{ message: string }>(`/admin/courses/categories/${categoryId}`);
  },

  // ─── Difficulties ────────────────────────────────────────

  /** Create a new difficulty level */
  createDifficulty: async (data: { labelEn: string; labelAr?: string }): Promise<{ difficulty: DifficultyOption }> => {
    return apiClient.post<{ difficulty: DifficultyOption }>('/admin/courses/difficulties', data);
  },

  /** Delete a difficulty level */
  deleteDifficulty: async (difficultyId: string): Promise<{ message: string }> => {
    return apiClient.delete<{ message: string }>(`/admin/courses/difficulties/${difficultyId}`);
  },
