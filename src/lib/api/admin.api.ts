...
export const adminApi = {
  ...
  getStudentVoiceSessions: (studentId: string) =>
    apiClient.get<{
      sessions: Array<{
        id: string;
        conversationId: string;
    ...
    }>(`/admin/trainee/${studentId}/voice-sessions`),

  getStudentSimulations: (studentId: string) =>
    apiClient.get<{
      sessions: Array<{
        id: string;
        studentId: string;
    ...
    }>(`/admin/trainee/${studentId}/simulations`),
  ...
  getStudentReports: (studentId: string) =>
    apiClient.get<{
      ...
      lastName: string;
      email: string;
    }>(`/admin/trainee/${studentId}/reports`),
};
