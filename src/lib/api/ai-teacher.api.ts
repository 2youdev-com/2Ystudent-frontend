...
export const aiTeacherApi = {
  ...
  getProfile: async (): Promise<StudentProfile> => {
    return apiClient.get<StudentProfile>('/ai-teacher/profile');
  },

  updateProfile: async (updates: Partial<StudentProfile>): Promise<StudentProfile> => {
    return apiClient.patch<StudentProfile>('/ai-teacher/profile', updates);
  },

  syncProfile: async (): Promise<StudentProfile> => {
    return apiClient.post<StudentProfile>('/ai-teacher/profile/sync', {});
  },
